...
public class ScorecardTeam2Fragment extends Fragment {
    ...
    public ScorecardTeam2Fragment (ArrayList<Batsman> batsmen, ArrayList<Bowler> bowlers, String batting_team_score) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_scorecard_team2, container, false);

//Batting Scorecard
        batting_rec_view = root.findViewById(R.id.scorecard_batting2);
    //        batting_rec_view.setHasFixedSize(true);
...
//Bowling Scorecard
        bowling_rec_view = root.findViewById(R.id.scorecard_bowling2);
    //        bowling_rec_view.setHasFixedSize(true);
...
//Batting Total
        batting_total = root.findViewById(R.id.batting2_total);
